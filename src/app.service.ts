...
export class AppService {
  ...
  get devInstructions(): string {
    if (this.isDev) {
      return `<div>Welcome to Parchment TMS API.</div><p>To get started, please refer to the Swagger Documentation <a href="http://localhost:${this.port}/api-docs">here</a>.</p>`;
    }
